        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.child("usertype").getValue(String.class).equals("FARMER")){
                    FirebaseDatabase.getInstance().getReference("Trades").orderByChild("farmerid").equalTo(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                    ...
                    FirebaseDatabase.getInstance().getReference("Trades").orderByChild("supplierid").equalTo(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            int total=0;
                            for(DataSnapshot ds:dataSnapshot.getChildren()){

        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()) {
                    ...
                    String buyername = dataSnapshot.child("buyername").getValue(String.class);
                    String buyermobile = dataSnapshot.child("buyermobile").getValue(String.class);
                    String buyeraddress = dataSnapshot.child("buyeraddress").getValue(String.class);
                    ...
                    if(acceptstatus.equals("FALSE")) {
                        CropAccept crop = new CropAccept(requestid, cropname, croptype, quantity, buyername, buyermobile, buyeraddress, buyerid, requestdate, acceptstatus);
                        list.add(crop);
                    }
                }
